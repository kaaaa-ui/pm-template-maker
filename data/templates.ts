...
const jaTemplates: Record<Scene, Record<Target, Record<Tone, TemplateSet>>> = {
  ...
  regular: {
    english: {
      sweet: {
        short: 'いつも来てくれてありがとう💕 {name}さんがいると安心する😊',
        medium: 'いつも配信に来てくれてありがとう💕 {name}さんがチャットにいるとすごく安心するの😊 今日も会えるの楽しみにしてるね💕',
        long: 'いつも来てくれて本当にありがとう💕 {name}さんがいない配信って考えられないくらい、あなたの存在が大きいの😊 いつも盛り上げてくれるし、私のこと応援してくれるし…ほんとに感謝してる。今日も一緒に楽しもうね💕',
      },
      mature: {
      ...
      energetic: {
        short: 'いつもありがとう!!✨ {name}さんがいると盛り上がりが違う⚡',
        medium: 'いつも来てくれてありがとう!!✨ {name}さんがチャットにいると配信のテンションが3倍になるの⚡ 今日もぶちかまそうね！！🎉',
        long: 'いつも来てくれてほんとにありがとう!!✨ もうね、{name}さんがログインしたの見えた瞬間「キター！！」ってなるの⚡笑 あなたがいると配信が100倍楽しい！！今日も一緒に最高の時間にしようね！！🎉✨',
      },
      mysterious: {
    ...
    japanese: {
      sweet: {
        short: 'いつもありがとう💕 {name}さん大好き！今日も待ってるね😊',
        medium: 'いつも来てくれてありがとう💕 {name}さんの顔見るとほっとするの😊 私にとって特別な存在だよ。今日もよろしくね💕',
        long: 'いつも本当にありがとう💕 {name}さんがいてくれるから頑張れるの。配信前にいつも「今日も来てくれるかな」って考えちゃう😊 あなたのおかげで毎日楽しい！今日も一緒に最高の時間にしようね💕大好き！',
      },
      mature: {
      ...
      energetic: {
        short: 'いつもありがとう!!✨ {name}さん最高！！⚡',
        medium: 'いつも来てくれてありがとう!!✨ {name}さんがいるとマジで楽しい！！今日も全力で盛り上げるからね⚡🎉',
        long: 'いつもいつも来てくれてありがとう!!✨ {name}さんがいない配信なんて考えられない！！あなたのコメントでいつも元気もらってるし、配信のMVPは間違いなくあなた⚡ 今日も一緒にぶち上げようね！！🎉✨',
      },
      mysterious: {
    ...
    chatty: {
      sweet: {
        ...
        medium: 'いつもチャットで盛り上げてくれてありがとう💕 {name}さんとの会話が配信の楽しみなの😊 今日もいっぱい話そうね💕',
        long: 'いつもチャットしてくれて本当にありがとう💕 {name}さんの話って面白くて、いつも笑っちゃうの😊 前に話してた{name}の件、その後どうなった？気になってたの！今日も色々教えてね💕',
      },
      mature: {
      ...
      energetic: {
        ...
        medium: 'いつもチャットで盛り上げてくれてありがとう!!✨ {name}さんのツッコミのセンス天才！！⚡ 今日もキレキレのコメント待ってるよ🎉',
        long: 'いつもチャット盛り上げてくれてありがとう!!✨ {name}さんのコメントが来ると配信の空気が一気に変わるの知ってた？⚡ あなたは配信の盛り上げMVP！！今日も全力トークで楽しもうね！！🎉✨',
      },
      mysterious: {
  ...
  dormant: {
    english: {
      ...
      energetic: {
        ...
        long: '久しぶり!!✨ 元気してる？最近配信してて「あー、{name}さんいたらもっと盛り上がるのに！」って思うことあるの⚡ 忙しい時は無理しなくていいからね！でもまた来てくれたらめちゃめちゃ嬉しい！！🎉✨',
      },
      mysterious: {
    ...
    japanese: {
      sweet: {
        short: '久しぶり💕 {name}さんのこと思い出してた😊',
        medium: '久しぶり💕 最近元気？{name}さんのこと最近思い出してて、連絡しちゃった😊 忙しいよね。無理しないでね。また遊びに来てくれたら嬉しいな💕',
        long: '久しぶり！元気にしてる？💕 最近ふと{name}さんのこと思い出すことがあって…前に話してくれたこと覚えてるよ😊 忙しいのかな、それとも疲れちゃったかな。無理はしないでね。でもまた気が向いたらいつでも来てね。{name}さんの居場所、ちゃんとあるから💕',
      },
      mature: {
      ...
      energetic: {
        short: '久しぶり!!✨ {name}さん元気？会いたいよ〜⚡',
        medium: '久しぶり!!✨ 最近見ないけど元気してる？{name}さんがいないと配信ちょっと寂しいの！⚡ また気が向いたら遊びに来てね〜🎉',
        long: '久しぶり!!✨ 元気にしてた？最近「{name}さんどうしてるかな〜」って考えてて！⚡ 忙しい時は全然いいからね！でもまた来てくれたら全力でお迎えするから！！帰ってきたらお祭り状態にするよ！！🎉✨',
      },
      mysterious: {
    ...
    chatty: {
      sweet: {
        ...
        long: '久しぶり！💕 前にチャットで{name}の話で盛り上がったの覚えてる？あの時ほんと楽しかった😊 最近またあのテーマの新しいネタがあるの！聞いてほしいな〜。気が向いた時でいいから、また遊びに来てね💕',
      },
      mature: {
      ...
      energetic: {
        ...
        long: '久しぶり!!✨ 覚えてる？前にチャットで{name}の話で盛り上がった時！！あの時のテンション最高だったよね⚡ 最近また面白いネタ仕入れたから、聞いてほしいの！！また遊びに来てよ〜🎉✨',
      },
      mysterious: {
    ...
    silent: {
      ...
      energetic: {
        ...
        long: '久しぶり!!✨ {name}さんのこと覚えてるよ！チャットしなくても毎回来てくれてたよね？⚡ それだけで嬉しかったの！最近見ないから「どうしてるかなー」って！無理はしなくていいから、また気が向いた時にふらっと来てね🎉✨',
      },
      mysterious: {
  ...
  whale: {
    ...
    japanese: {
      sweet: {
        ...
        medium: 'いつもいつも応援してくれて💕 {name}さんのおかげで毎日頑張れるの😊 私の一番の味方だよ。ほんとにありがとう💕',
        long: 'いつも温かい応援ありがとう💕 {name}さんがいなかったら今の私はいないと思う😊 いつも支えてくれて、信じてくれて、応援してくれて…もう感謝しかない。これからも{name}さんと一緒にもっと上を目指したい！大好きだよ💕',
      },
      mature: {
      ...
      energetic: {
        short: 'いつもありがとう!!✨ {name}さんが最強！！⚡',
        medium: 'いつも応援ありがとう!!✨ {name}さんがいると配信パワーが無限大！！⚡ 感謝を全力で配信に込めるからね🎉',
        long: 'いつも応援ありがとう!!✨ もうね、{name}さんの応援パワーが凄すぎて感動しっぱなし！！⚡ この感謝を形にするために、もっともっとすごい配信にするから！一緒に伝説作ろう！！🎉✨',
      },
      mysterious: {
    ...
    chatty: {
      sweet: {
        ...
        medium: 'いつも応援してくれて、しかもチャットでも盛り上げてくれて💕 {name}さんは最高の存在！話すの楽しいし応援も嬉しいし😊 ありがとう💕',
        long: 'いつも応援してくれて、チャットでもたくさん話してくれて本当にありがとう💕 {name}さんとの会話が配信のハイライトなの😊 応援の気持ちも会話も全部嬉しい。あなたみたいな人がいてくれて幸せ。これからもよろしくね💕',
      },
      mature: {
      ...
      energetic: {
        ...
        medium: 'いつも応援＆チャットありがとう!!✨ 応援してくれてチャットも面白いとか最強すぎない？⚡ {name}さんがいると全てが最高！！🎉',
        long: 'いつも応援もチャットもありがとう!!✨ {name}さんマジで最強コンボだよ！！応援パワーでテンション上がって、チャットで笑いが止まらなくて⚡ こんな完璧な人いる？！感謝しかない！！これからも一緒にぶち上げよう！！🎉✨',
      },
      mysterious: {
    ...
    silent: {
      ...
      energetic: {
        ...
        long: 'いつも応援ありがとう!!✨ {name}さんって静かに応援してくれるタイプだよね？それがまた格好いいの！！⚡ 言葉より行動で示すスタイル、尊敬してる！！最高の味方がいるから私も全力で行けるんだよね🎉✨',
      },
      mysterious: {
  ...
  first_tip: {
    ...
    japanese: {
      ...
      energetic: {
        ...
        medium: '初チップありがとう!!✨ 嬉しすぎてリアルに「やったー！」って叫んだよ⚡ {name}さん最高すぎる！！🎉',
        long: '初チップありがとう!!✨ もうね、感動が止まらない！！初チップを私に送ってくれるなんて嬉しすぎるよ⚡ この感謝を込めて次の配信は{name}さんのために全力で盛り上げるからね！！約束！！🎉✨',
      },
      mysterious: {
    ...
    chatty: {
      sweet: {
        ...
        long: '初チップありがとう💕 いつもチャットで楽しませてくれてるのに、チップまで送ってくれるなんて😊 前に話してた{name}の件、覚えてるよ！あなたとの会話も応援も、全部宝物。これからもいっぱい話そうね💕',
      },
      mature: {
      ...
      energetic: {
        ...
        long: '初チップありがとう!!✨ ちょっと待って！！いつもチャットでめちゃ楽しい時間くれるのに、チップまで送ってくれちゃうの？！⚡ {name}さん最強すぎでしょ！！感動がすごい！！次の配信で全力でお返しするからね！！🎉✨',
      },
      mysterious: {
    ...
    silent: {
      ...
      energetic: {
        ...
        long: '初チップありがとう!!✨ ちょっと待って！！いつも静かに見てくれてた{name}さんから初チップ？！⚡ サプライズすぎる！！嬉しすぎて震えた！！言葉じゃなくて行動で示すスタイル、かっこいい！！🎉✨',
      },
      mysterious: {
...
// --- Pro Tips per Scene ---
const proTips: Record<Scene, string[]> = {
  new_follower: [
    'フォロー通知が来たら24時間以内にPMを送る。記憶が新鮮なうちが返信率3倍',
    '相手のプロフィールを一言でも触れると「ちゃんと見てくれてる」感が出る',
    '最初のPMでチップやリクエストの話は絶対NG。まず「人として興味がある」を見せる',
    '短いPMでも「次の配信で話しかけるね」の一言があると来てくれる確率UP',
    '英語圏ユーザーには絵文字少なめ（1-2個）がベスト。日本人には多め（3-4個）でOK',
  ],
  regular: [
    '毎回同じ文面は絶対NG。前回の配信で話した内容に触れると特別感が出る',
    '配信2時間前に送るのがベスト。予定を空けてもらえる確率が最も高い',
    '週1-2回がベスト頻度。毎日送ると「重い」と思われる',
    '「今日は〇〇するよ！」と配信内容を予告すると来てくれる確率UP',
    'チップのお礼PMと配信告知PMは分ける。ごちゃ混ぜにすると催促に見える',
  ],
  dormant: [
    '「最近来てくれないね」は絶対NG。罪悪感を与えると二度と戻らない',
    '時事ネタや季節イベントをフックに「元気？」と自然に声をかけるのが最強',
    '1回送って反応なければ2週間は空ける。連投は完全逆効果',
    '前に話した内容を覚えていることを示すと「覚えてくれてたんだ」と感動される',
    '戻ってきてくれた時は全力歓迎。「久しぶり！」のリアクションが次の来訪を決める',
  ],
  whale: [
    '金額には絶対触れない。「たくさんありがとう」もNG。金額を意識させない',
    '他のユーザーと比較しない。「一番」「最高額」などの表現は避ける',
    '太客PMは月1-2回の特別感が大事。頻度が多いと価値が下がる',
    'チップの感謝ではなく「あなたがいてくれること」への感謝を伝える',
    '配信外でも「あなたのことを考えていた」と伝えると特別感MAX',
  ],
  first_tip: [
    '初チップPMは30分以内に送る。感動を共有するタイミングが命',
    '「もっと送って」「次も期待」は絶対NG。初体験の感動を汚す最悪パターン',
    '「初めてのチップを私に送ってくれた」という事実自体に感謝する',
    '次回以降は常連PM路線に自然に切り替える。初チップ感謝は1回限りの特別演出',
    'チップの金額に関わらず同じ熱量で感謝する。少額だからと手を抜くと二度と来ない',
  ],
}
